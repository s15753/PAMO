...
public class StabilnoscPH extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        buttons[0] = root.findViewById(R.id.bt_KH_0);
        buttons[1] = root.findViewById(R.id.bt_KH_3);
        buttons[2] = root.findViewById(R.id.bt_KH_6);
        buttons[3] = root.findViewById(R.id.bt_KH_10);
        buttons[4] = root.findViewById(R.id.bt_KH_15);
        buttons[5] = root.findViewById(R.id.bt_KH_20);
        btn_KH_none = root.findViewById(R.id.bt_lack_of_data);
